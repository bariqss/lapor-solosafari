...
<div class="container px-6 mx-auto grid">
    ...
    <div class="flex items-center justify-end">
        <button data-modal-target="crud-modal" data-modal-toggle="crud-modal" type="button"
            class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-4 focus:outline-none">Tambah</button>
    </div>
                ...
                <tbody class="bg-white divide-y">
                    ...
                    <tr class="text-gray-700">
                        ...
                        <td class="px-4 py-3 text-center text-sm">
                            ...
                            <span
                                class="bg-blue-100 text-blue-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">Verified</span>
                            @else
                            <span
                                class="bg-yellow-100 text-yellow-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-yellow-900 dark:text-yellow-300">Unverified</span>
                            @endif
                        </td>
                        ...
                        <td class="px-4 py-3">
                            <div class="flex justify-center">
                                <button type="button" data-modal-target="detail-modal{{$petugas->id}}"
                                    data-modal-toggle="detail-modal{{$petugas->id}}"
                                ...
                                <!-- Main modal detail -->
                                <div id="detail-modal{{$petugas->id}}" data-modal-backdrop="static" tabindex="-1"
                                    aria-hidden="true"
                                        ...
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-4 md:p-5 space-y-4">
                                                <div class="col-span-2">
                                                    <label for="name"
                                                        class="block text-sm font-semibold text-gray-900">Nama</label>
                                                    <h2>{{ $petugas->name }}</h2>
                                                </div>
                                                <div class="col-span-2 sm:col-span-1">
                                                    <label for="price"
                                                        class="block text-sm font-semibold text-gray-900">Email</label>
                                                    <h2>{{ $petugas->email }}</h2>
                                                </div>
                                                <div class="col-span-2 sm:col-span-1">
                                                    <label for="telp"
                                                        class="block text-sm font-semibold text-gray-900">No.
                                                        Telepon</label>
                                                    <h2>{{ $petugas->telepon }}</h2>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
