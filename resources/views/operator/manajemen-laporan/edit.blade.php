                ...
                <form action="{{ route('operator.manajemen-laporan.update', $report->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="level" name="level"
                            ...
                            <option value="3" {{ $report->level == "3" ? "selected" : "" }}>Tinggi</option>
                        </select>
                    </div>
                    <div class="mb-3">
                        <label for="status" class="block mb-2 text-sm font-semibold text-gray-900">
                            Status Penanganan
                        </label>
                        <select id="status" name="status"
                            ...
                            <option value="3" {{ $report->status == "3" ? "selected" : "" }}>Selesai</option>
                        </select>
                    </div>
