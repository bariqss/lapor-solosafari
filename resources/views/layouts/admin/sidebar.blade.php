<aside class="z-20 hidden w-64 overflow-y-auto bg-white md:block flex-shrink-0">
    <div class="py-4">
        ...
        <ul>
            ...
            <li class="relative px-6 py-2">
                <a class="inline-flex p-2 items-center w-full text-sm font-medium transition-colors duration-150 rounded-lg hover:bg-gray-100 hover:text-green-500 group {{ request()->routeIs('admin.manajemen-akun.index') ? 'bg-gray-100 font-semibold text-green-500' : '' }}"
                    href="{{ route('admin.manajemen-akun.index') }}">
