    ...
    <div class="py-4">
        ...
        <ul class="mt-6">
            <li class="relative px-6 py-2">
                <a class="nav-link inline-flex p-3 items-center w-full text-sm text-white font-medium transition-colors duration-150 rounded-lg hover:bg-gray-100 hover:font-semibold hover:text-gray-700 group {{ request()->routeIs('operator.manajemen-laporan.index') ? 'bg-gray-100 font-semibold text-gray-700' : '' }}"
                    ...
                    <span class="nav-link ml-4">Dashboard</span>
                </a>
            </li>
        </ul>
        <ul>
            <li class="relative px-6 py-2">
                <a class="inline-flex p-3 items-center w-full text-sm text-white font-medium transition-colors duration-150 rounded-lg hover:bg-gray-100 hover:font-semibold hover:text-gray-700 group {{ request()->routeIs('operator.manajemen-petugas.index') ? 'bg-gray-100 font-semibold text-gray-700' : '' }}"
