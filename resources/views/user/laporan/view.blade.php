    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
        ...
        <li>
            <div class="flex items-center">
                ...
                <span class="ms-1 text-sm font-medium text-gray-700 md:ms-2">Detail
                    Laporan
                </span>
            </div>
        </li>
            ...
            <div class="mt-4">
                <div class="mb-4 sm:col-span-2">
                    ...
                    <span
                        ...
                        Valid</span>
                    @else
                    <span class="bg-red-100 text-red-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded-full">Laporan
                        Tidak
                        Valid</span>
                    @endif
                </div>
                ...
                <div class="mb-4 sm:col-span-2">
                    ...
                    <span class="bg-green-100 text-green-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded-md">Belum
                        Ditangani</span>
